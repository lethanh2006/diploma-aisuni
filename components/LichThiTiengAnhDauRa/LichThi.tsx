...
const LichThi = ({}) => {
  ...
  const data = {
    ...
    content:
      "Do ảnh hưởng của đại dịch Covid - 19 đã khiến cho quá trình đăng ký và thi chứng chỉ tiếng anh TOEIC bị gián đoạn.Australian International School thông báo điều chỉnh thời gian thi Chuẩn đầu ra Tiếng Anh Đợt 2 năm 2020 như sau:",
  };
