...
const GlobalFooter = () => {
  ...
  return (
    <Box style={{ backgroundColor: "#0079C1", color: "#ffffff", paddingTop: '40px', paddingBottom: '20px', fontFamily: "Roboto, sans-serif" }}>
      <Container>
        <div style={{ width: '100%' }}>
          ...
          <Row type="flex" justify="space-between" align="middle" style={{ paddingBottom: '30px', borderBottom: '1px dashed rgba(255,255,255,0.3)' }}>
            ...
            <Col xs={24} md={6} style={{ display: 'flex', justifyContent: 'flex-end', gap: '15px' }}>
              <a href="https://www.facebook.com/AISSaigon/" target="_blank" rel="noreferrer" style={{ width: '40px', height: '40px', backgroundColor: 'rgba(255,255,255,0.15)', borderRadius: '50%', display: 'flex', justifyContent: 'center', alignItems: 'center', cursor: 'pointer', transition: 'all 0.3s' }}>
          ...
          {/* NOTE: SECTION 2 - Contact details */}
