    ...
    <div style={{ padding: "32px 64px", backgroundColor: "#f8f9fa", minHeight: "350px", borderTop: "1px solid #e8e8e8", borderBottom: "1px solid #e8e8e8" }}>
      <div style={{ maxWidth: "1200px", margin: "0 auto" }}>
        <h3 style={{
          ...
          >
            <path d="M22.6666 22L28 27.3333" stroke="#0079C1" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" />
            <circle cx="14.6667" cy="14.6667" r="10.6667" stroke="#0079C1" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" />
          </svg>
        </h3>
        {isEmpty ? (
          <div style={{
