...
const TinTuc = ({ dataDeAn, dataMucLuc }) => {
  ...
  return (
    <>
      <NextSeo
        title="Đề án tuyển sinh Australian International School năm 2021"
        description="Thông tin chi tiết về đề án tuyển sinh Australian International School"
        canonical="https://daotao.aisenote.com/"
        openGraph={{
          url: `https://daotao.aisenote.com/`,
          title:
            "Đề án tuyển sinh Australian International School năm 2021",
          description:
            "Thông tin chi tiết về đề án tuyển sinh Australian International School",
          images: [
            {
              url: bgNganhHOc,
              width: 800,
            ...
            <Col lg={24} xl={24} md={24} xs={24} sm={24}>
              <div id="content">
                ...
                <h4 style={{ fontSize: "calc(1vw + 10px)", color: "#D10000" }}>
                  "Đề án tuyển sinh Australian International School năm
                  2021"
                </h4>
