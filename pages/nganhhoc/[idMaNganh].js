  ...
  return (
    <>
      <NextSeo
        ...
        description="Thông tin chi tiết về các ngành học tại Australian International School"
        canonical="https://daotao.aisenote.com/"
        openGraph={{
          url: `https://daotao.aisenote.com/nganhhoc/${namO?.maNganh}`,
          title: data[0]?.tenNganh,
          description:
            "Thông tin chi tiết về các ngành học tại Australian International School",
          images: [
            {
              url: bgNganhHOc,
              width: 800,
